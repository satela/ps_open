package script.login
{
	...
	public class RegisterCntrol extends Script
	{
		...
		private var serviceTxt:String = "尊敬的用户：\n" +
     									"   品赋阳光是专业的为广告及相关产品委托生产、买卖、交付等提供服务的网站（下称“本网站”），为广告相关产品及其他产品的委托生产、买卖、交付等的双方用户提供居间服务及其他相关服务，在此特别提醒用户认真阅读本《服务协议》(下称“本协议”)中各个条款，并确认是否同意本协议条款。用户的使用行为将视为对本协议的接受，并同意接受本协议各项条款的约束。\n\n" + 
...
//			uiSkin.input_receiverphone.restrict = "0-9";
			...
			var companyNme:String = json["companyName"];
			
			uiSkin.sevicepro.text = serviceTxt.replace("品赋阳光",companyNme);
